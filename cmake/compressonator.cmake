...
if (NOT DEFINED ENV{COMPRESSONATOR_ROOT})
    message(FATAL_ERROR "COMPRESSONATOR_ROOT environment variable is not defined. Please set COMPRESSONATOR_ROOT to the path of the Compressonator SDK.")
endif()
...
message(NOTICE "Compressonator SDK found in " ${COMPRESSONATOR_ROOT})
