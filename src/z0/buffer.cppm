...
export namespace z0 {
    ...
    public:
        ...
        [[nodiscard]] VkDescriptorBufferInfo descriptorInfo(const VkDeviceSize size   = VK_WHOLE_SIZE,
        ...
        void writeToBuffer(const void *       data, const VkDeviceSize size = VK_WHOLE_SIZE,
                           const VkDeviceSize offset                        = 0) const {
